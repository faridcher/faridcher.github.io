...
sidebar:
  ...
  - title: "OTN Profile"
    text: "[My oracle profile](https://community.oracle.com/people/Farid+Cher)"
gallery:
  - url: taf/hq/Search.jpg
    image_path: taf/Search.jpg
  - url: taf/hq/Print.jpg
    image_path: taf/Print.jpg
  - url: taf/hq/SpatialQuery.jpg
    image_path: taf/SpatialQuery.jpg
  - url: taf/hq/Layers.jpg
    image_path: taf/Layers.jpg
  - url: taf/hq/Tools.jpg
    image_path: taf/Tools.jpg
  - url: taf/hq/UpdateLayer.jpg
    image_path: taf/UpdateLayer.jpg
---
{% include toc icon="" title="Table of Contents" %}

My experience with oracle Spatial backs to 2012-2013 when I was working as a database developer in a private company called [Negasht Rahavard Sharq](http://www.nrsgeo.com/). I have been involved in a project for municipality called [detailed plan of Tehran](http://en.tehran.ir/ViewArticle/tabid/77/ArticleId/630/Detailed-Plan-Is-Tehrans-Strategic-Document-for-Urban-Management.aspx). The technologies that were used in the project were ASP.NET, C#.NET, oracle Spatial (DB back-end), Oracle maps (as a web map viewer) and ESRI ArcGIS with ArcSDE to edit the data.
...
{% include gallery caption="screenshots of the detailed plan of Tehran" %}
